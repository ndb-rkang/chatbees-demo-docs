...
integration.addBuildEventHandler("onBuild", async ({ constants, utils }) => {
  ...
  writeFileSync(indexFile, data)
});


integration.addBuildEventHandler("onSuccess", async ({ constants, utils }) => {
  ...
  let crawlCompleted: boolean = false;
